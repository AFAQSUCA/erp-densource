...
> 20 fichier(s) dans ce chapitre, 1700 lignes de code.
...
*664 lignes* — Logique métier RH : recrutement et workflow de congés en 3 niveaux.
...
*30 lignes* — Événements du workflow de congés (souscrits par ``notifications``).
...
*23 lignes* — Qui peut consulter et gérer le personnel et les congés.
