...
Performance : 23 requêtes SQL quel que soit le volume de données (testé). Les blocs
...
Reste à faire :
- **Indicateurs financiers** (CA facturé, encaissé, charges, marge nette, créances, factures
  impayées) et dashboard Finances : dépendent de la facturation (étape 4). Le bloc affiche une
  annonce, jamais de faux chiffres.
